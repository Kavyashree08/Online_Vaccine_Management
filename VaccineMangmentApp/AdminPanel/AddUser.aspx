<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="VaccineMangmentApp.AdminPanel.AddUser" %>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-4" style="margin-left: 200px">
                        <h3 class="text-danger pl-4">Add User</h3>
                        <div class="col-4">
                        ...
                        <form runat="server">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <asp:CheckBox ID="chkIsAdmin" CssClass="form-control" runat="server" />
                            </div>
                            <br />
